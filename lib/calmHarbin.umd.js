    ...
    get: function get() {
      ...
      this.cacheList.forEach(function (item) {
        if (!tableData.find(function (i) {
          return i[_this4.prop.id] === item[_this4.prop.id];
        })) {
          tableData.push(item);
        }
      });
      ...
      if (this.multiple) {
        if (!util_isEqualWith(this.value, newVal)) {
          ...
          this.customTableData.forEach(function (item) {
            if (newVal.includes(item[_this5.prop.id])) {
              cacheList.push(item);
            }
          });
    ...
    value: function rowClick(row) {
      ...
      if (this.multiple) {
        ...
        var index = this.checkList.findIndex(function (item) {
          return row[_this6.prop.id] === item;
        });
...
var biu_select_table_component = normalizeComponent(
  ...
  biu_select_tablevue_type_template_id_9de7319e_render,
  biu_select_tablevue_type_template_id_9de7319e_staticRenderFns,
  false,
  null,
  null,
  null
